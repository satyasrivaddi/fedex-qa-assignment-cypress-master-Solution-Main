...
class SearchPage{
    ...
    navigateToApplication() // function to navigate to application URL
    {
    ...
    peopleSearchWithEnter(value)  // function to search people by pressing "Enter"
    {
    ...
    planetSearchWithEnter(value)  // function to search planets by pressing "Enter"
    {
    ...
    searchFormClear()  // function to clear Search form
    {
        const searchText = cy.get('#query')
        searchText.clear()
    }
