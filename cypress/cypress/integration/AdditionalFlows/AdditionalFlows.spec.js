...
Given('Application is running',()=>{
    searchPage.navigateToApplication() // function to navigate to application URL
    ()
})
...
When('I press enter search for the Planet {string}',(planetName)=>{
    ...
    searchPage.planetSearchWithEnter(planetName)
})
...
When('I enter search for the Character {string}',(CharName)=>{
    ...
    searchPage.peopleSearchWithEnter(CharName)
})
