Feature: Verify additional flows for search functionality
    ...
    Scenario: Verify that after a successful result displayed for character search, if the search form is cleared and clicked Search, empty results list should be displayed
        Given Application is running properly
    ...
    Scenario: Verify that after a successful result displayed for character search, if the search form is cleared and clicked Search, empty results list should be appeared
    ...
    Scenario: Verify that after a successful result displayed for character search, if the planet radio button is checked and clicked Search, no results list should be appeared
        Given Application is running
    ...
    Scenario: Verify that after a successful result displayed for planet search, if I switch to the people radio button and click on Search button, no results list should be found
        Given Application is running
        When I select search for the Planet "Tatooine"
        Then I should be able to see Planet details
        |name|population|climate|gravity|
    ...
    Scenario: Verify the application behaviour when partial character search results in multiple results
        Given Application is running
        When I select search for a valid partial charcter name "DA"
        Then I should be able to see multiple results
    
    Scenario: Verify the application behaviour when partial planet name search results in multiple results
        Given Application is running
        When I select search for a valid partial planet name "Al"
        Then I should be able to see multiple results
